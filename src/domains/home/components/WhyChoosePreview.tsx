...
const pillars = [
  {
    ...
    description: "Experienced accounting and tax professionals.",
  },
  {
    icon: Users,
    title: "Personalized Service",
    description: "Solutions designed around each client's business and financial situation.",
  },
  {
    icon: Cloud,
    title: "Technology-Enabled",
    description: "Modern cloud-based and paperless accounting workflows.",
  },
  {
    icon: ShieldCheck,
    title: "Tax & Compliance",
    description: "Support with tax preparation, planning and CRA compliance.",
  },
  {
    icon: BarChart3,
    title: "Business Insight",
    description: "Financial data used to help clients understand their businesses.",
  },
  {
    icon: Wallet,
    title: "Cost-Conscious",
    description: "Practical and cost-effective advisory for entrepreneurs and small businesses.",
  },
];
